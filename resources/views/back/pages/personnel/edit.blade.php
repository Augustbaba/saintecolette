...
<div class="dashboard-main-body">
    ...
    <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
            <h1 class="fw-semibold mb-4 h6 text-primary-light">Modifier — {{ $membre->name }}</h1>
            <div>
                <a href="{{ route('admin.dashboard') }}" class="text-secondary-light hover-text-primary hover-underline">Dashboard</a>
                <span class="text-secondary-light">/ <a href="{{ route('admin.personnel.index') }}" class="text-secondary-light hover-text-primary hover-underline">Personnel</a></span>
        ...
        <div class="col-md-8 col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">
                        <i class="ri-edit-line me-2 text-primary-600"></i>Modifier le membre
                    </h5>
                </div>
                <div class="card-body">
