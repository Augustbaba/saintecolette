...
<div class="dashboard-main-body">
    ...
    <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        ...
        <a href="{{ route('admin.personnel.create') }}" class="btn btn-primary-600 d-flex align-items-center gap-6">
    ...
    <div class="card mb-24">
        <div class="card-body py-2">
            <form method="GET" action="{{ route('admin.personnel.index') }}"
                ...
                <a href="{{ route('admin.personnel.index') }}" class="btn btn-sm btn-outline-secondary">
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        @php
                            ...
                            $rc = $roleColors[$membre->role] ?? 'gray';
                        @endphp
                        <tr>
                            <td>{{ $membre->id }}</td>
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <div class="rounded-circle d-flex align-items-center justify-content-center fw-bold text-sm bg-neutral-200"
                            ...
                            <td>
                                <span class="badge px-12 py-6 fw-medium radius-4
                                    @switch($membre->role)
                                        @case('censeur')    bg-purple-100 text-purple-600  @break
                                        @case('secretaire') bg-primary-100 text-primary-600 @break
                                        @case('comptable')  bg-warning-100 text-warning-600 @break
                                        @case('surveillant')bg-success-100 text-success-600 @break
                            ...
                            <td>
                                @if($membre->actif)
                                    <span class="badge bg-success-100 text-success-600 px-12 py-6 radius-4">Actif</span>
                                @else
                                    <span class="badge bg-danger-100 text-danger-600 px-12 py-6 radius-4">Inactif</span>
                                @endif
                            </td>
                            <td>
                                <div class="d-flex align-items-center gap-2">
